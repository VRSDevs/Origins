...
//////////////////////////////////////////////////////////////////////
class sceneAirLevelOnline extends Phaser.Scene {
    constructor() {
        super({
            key: "sceneAirLevelOnline",
            active: false
        });
    }
    create() {
        ...
        //******************* Mapa ************************//
        var map = this.make.tilemap({ key: 'airMap' });
        var tileset = map.addTilesetImage("fire", "tilesAir");
        // Capas //
...
function sendPlayerUpdate(key) {
    ...
    var wsConnection = server.getWSConnection()["fireMatch"];
...
//                          Exportaciones                           //
//////////////////////////////////////////////////////////////////////
export default sceneAirLevelOnline;